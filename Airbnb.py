...
st.set_page_config(page_title="AirBnb-Analysis by Pranav Bhawane    !!!", page_icon=":bar_chart:", layout="wide")
...
if SELECT == "Explore Data":
 ...
 if fl is not None:
    ...
    os.chdir(r"C:\Users\91888\Desktop\AirBNB_Data_Analysis")
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"Pranav Bhawane"}')
    mail = (f'{"Mail :"}  {"Bhawanepranav77@gmail.com"}')
